...
import {Table, Popover, Whisper, Checkbox,
Dropdown, IconButton, Divider,Icon} from "rsuite";
...
const NameCell = ({ rowData, dataKey, ...props }) => {
  ...
  const Menu = ({ onSelect }) => (
    <Dropdown.Menu onSelect={onSelect}>
      ...
      <Dropdown.Item eventKey={4}>Edit</Dropdown.Item>
  ...
  const data = stud.filter((v, i) => i < 20);
      ...
      return (
        <div>
          ...
          >
            ...
            <Column width={300}>
              <HeaderCell>Matric Card</HeaderCell>
              <Cell>
                {rowData => (
